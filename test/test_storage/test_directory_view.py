...
class TestDirectoryView(TestCase):
    ...
    def test_create_directory(self):
        create_dir_response = self.client.post("/api/directory", query_params={"path": "test/"}, extra={"format": "json"})
        assert create_dir_response.status_code == 201
        get_dir_content_response = self.client.get("/api/directory", query_params={"path": ""}, extra={"format": "json"})
